...
COLORS = {"{}-{}".format(x, y): [(x_c + y_c) / 2 for x_c, y_c in zip(x_cs, y_cs)] for x, x_cs in SIMPLE_COLORS.items() for y, y_cs in SIMPLE_COLORS.items()}
COLORS.update(SIMPLE_COLORS)

eps = .0001

CONTENT_FOLDER = "/scratch/eo41/adept/utils"
